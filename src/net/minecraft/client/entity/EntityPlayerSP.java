...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    private void onUpdateWalkingPlayer()
    {
    	...
    	EventMotion e2 = new EventMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            if (this.isRiding())
            {
                this.connection.sendPacket(new CPacketPlayer.PositionRotation(this.motionX, -999.0D, this.motionZ, e2.getYaw(), e2.getPitch(), e2.isOnGround()));
                flag2 = false;
            }
            else if (flag2 && flag3)
            {
                this.connection.sendPacket(new CPacketPlayer.PositionRotation(e2.getX(), e2.getY(), e2.getZ(), e2.getYaw(), e2.getPitch(), e2.isOnGround()));
            }
            else if (flag2)
            {
                this.connection.sendPacket(new CPacketPlayer.Position(e2.getX(), e2.getY(), e2.getZ(), e2.isOnGround()));
            }
            else if (flag3)
            {
                this.connection.sendPacket(new CPacketPlayer.Rotation(e2.getYaw(), e2.getPitch(), e2.isOnGround()));
            }
            ...
            if (flag2)
            {
                this.lastReportedPosX = e2.getX();
                this.lastReportedPosY = e2.getY();
                this.lastReportedPosZ = e2.getZ();
                this.positionUpdateTicks = 0;
            }

            if (flag3)
            {
                this.lastReportedYaw = e2.getYaw();
                this.lastReportedPitch = e2.getPitch();
            }
